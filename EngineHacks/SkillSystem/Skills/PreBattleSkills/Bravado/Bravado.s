...
bge ApplyBoost      @if greater than, the defender has some left over speed we can convert into attack
b   End             @otehrwise we branch to the end

@apply the skill effect
ApplyBoost:
mov r1, #0x60       @get the attack speed short
mov r2, #255
